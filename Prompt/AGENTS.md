...
regeln:
  ...
  - **Prompt/Rollen‑Prompt laden:** Nachdem du die Loop‑Notizen gelesen hast, öffne den angegebenen Rollen‑Prompt (z. B. `roles/planner_prompt.md`) und folge dessen Anweisungen.
  ...
  - **Leitfäden beachten:** Konsultiere den *Style Guide* (`guides/StyleGuide.md`), wenn du Daten strukturierst oder Dokumente pflegst, und verwende den *Prompt Guide* (`guides/Prompt_Guide.md`), um neue Arbeitsanweisungen oder Task‑Beschreibungen präzise und modular zu formulieren.
```
