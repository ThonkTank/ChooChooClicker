...
from ui.app import SPRITE_COORDINATES, ChooChooApp
...
def test_sprite_coordinate_metadata_matches_documentation() -> None:
    """Ensure the static sprite metadata stays in sync with the orientation notes."""
    ...
    assert SPRITE_COORDINATES == expected
